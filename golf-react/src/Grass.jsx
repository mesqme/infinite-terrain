...
const Grass = ({ size = 10, chunkX = 0, chunkZ = 0, noise2D }) => {
		...
		() =>
			new THREE.ShaderMaterial({
				uniforms: {
					...
					uGrassBaseColor: { value: new THREE.Color(controls.colorBase) },
					uGrassTopColor: { value: new THREE.Color(controls.colorTop) },
	...
	return (
		<>
			<mesh ref={grassRef} geometry={grassGeometry} material={grassMaterial} />
